...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-between text-center items-center">
      ...
      <br />
      <div>
        <Button type="button" onClick={() => setCargar(true)}>Cargar Post Iniciales API</Button>
      </div>
      <br />
      <div>
            ...
            <div className="container mx-auto bg-gray-100 py-10 flex justify-center" key={post.id}>
              <div className="bg-white w-80 shadow-lg cursor-pointer rounded transform hover:scale-105 duration-300 ease-in-out">
                ...
                <div className="p-4">
                  ...
                  <Button type="button" onClick={() => borrarPost(post.id)} className="block m-auto bg-gray-300 py-2 px-2 text-gray-600 text-center rounded shadow-lg uppercase font-light mt-6 hover:bg-gray-400 hover:text-white duration-300 ease-in-out">Borrar Post</Button>
                </div>
              </div>
            </div>
          );
